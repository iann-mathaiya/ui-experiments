...
export default function PricingCard() {
    ...
    return (
        <div className="m-4 py-4 px-4 lg:px-8 bg-white w-96 md:w-4/6 lg:w-2/6 h-fit drop-shadow-xl rounded-xl">
                            ...
                            {plans.map(plan => (
                                <RadioGroup.Option
                                    ...
                                    className={({ active, checked }) =>
                                        `${active ? 'border-2 border-pink-400' : 'bg-white'} 
                                        ${checked ? 'absolute z-10 top-10 inset-x-0 ease-in translate-y-10 scale-105 duration-300 w-full drop-shadow' : 'drop-shadow-none'} bg-white border-2 rounded-lg p-2`
                                    }>
                                    {({ active, checked }) => (
